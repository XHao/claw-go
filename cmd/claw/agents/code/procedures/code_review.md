...
1. **Understand intent** — what problem does this change solve?
2. **Read the diff** — check every changed line, not just the summary
3. **Correctness** — does it do what it claims? edge cases covered?
